...
class RiseTPBCAtomSelector(OriginalTPBCAtomSelector):
...
# for i in range(1000):
#     rise_tp_bc_atom_selector = RiseTPBCAtomSelector('random')
#     print(rise_tp_bc_atom_selector.rise_tp_info_dict)
#     print(i)

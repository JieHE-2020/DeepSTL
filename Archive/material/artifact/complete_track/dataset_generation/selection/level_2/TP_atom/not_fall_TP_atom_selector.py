...
class NotFallTPAtomSelector(OriginalTPAtomSelector):
...
# not_fall_tp_atom_selector = NotFallTPAtomSelector('random')
# print(not_fall_tp_atom_selector.not_fall_tp_info_dict)

...
class NotRiseTPAtomSelector(OriginalTPAtomSelector):
...
# not_rise_tp_atom_selector = NotRiseTPAtomSelector('random')
# print(not_rise_tp_atom_selector.not_rise_tp_info_dict)

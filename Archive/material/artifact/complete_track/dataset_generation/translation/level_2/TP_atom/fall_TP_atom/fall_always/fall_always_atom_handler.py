...
class FallAlwaysAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.fall_always_atom_translator = self.translate_process()
    ...
    def translate_process(self):
        ...
        fall_always_atom_translator = FallTPAtomTranslator(translate_guide, self.limit_num)

        return fall_always_atom_translator
...
# }
#
# fall_always_atom_handler = FallAlwaysAtomHandler(position, nest_info_dict)
# print(fall_always_atom_handler.fall_tp_info_dict)
# print(fall_always_atom_handler.fall_tp_info_dict['expression'])
# print(fall_always_atom_handler.tp_info_dict['expression'])
# print('\n')
# fall_always_atom_handler.fall_always_atom_translator.display_random_translation()

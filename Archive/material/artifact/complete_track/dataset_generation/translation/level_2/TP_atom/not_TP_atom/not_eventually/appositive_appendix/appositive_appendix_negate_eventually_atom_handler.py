...
class AppositiveAppendixNegateEventuallyAtomHandler:
    ...
    def __init__(self, translate_guide, limit_num):
        ...
        self.eventually_limit_num = self.limit_num * parameters.tp_atom_factor_simplest_normal

        self.instruction_dict = self.instruction_assemble()

        self.appositive_appendix_negate_eventually_atom_translator = self.translate_process()
    ...
    def instruction_assemble(self):
        ...
        eventually_instruction_dict = {
            ...
            'tp_info_dict': self.translate_guide['eventually_info_dict']
        }
    ...
    def translate_process(self):
        ...
        appositive_appendix_negate_eventually_atom_translator = NotTPAtomTranslator(guide, self.limit_num)

        return appositive_appendix_negate_eventually_atom_translator

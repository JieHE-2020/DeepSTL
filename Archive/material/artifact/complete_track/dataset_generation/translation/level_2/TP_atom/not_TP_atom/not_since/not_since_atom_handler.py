...
class NotSinceAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num):
        ...
        self.since_limit_num = parameters.limit_num_tp_atom_simplest_normal
        ...
        self.not_since_atom_translator = self.translate_process()
    ...
    def translate_process(self):
        ...
        not_since_atom_translator = NotTPAtomTranslator(translate_guide, self.limit_num)

        return not_since_atom_translator
...
# not_since_atom_handler = NotSinceAtomHandler(position, nest_info_dict, limit_num)
# print(not_since_atom_handler.not_tp_info_dict)
# print(not_since_atom_handler.not_tp_info_dict['expression'])
# print(not_since_atom_handler.tp_info_dict['since']['expression'])
# print('\n')
# not_since_atom_handler.not_since_atom_translator.display_random_translation()

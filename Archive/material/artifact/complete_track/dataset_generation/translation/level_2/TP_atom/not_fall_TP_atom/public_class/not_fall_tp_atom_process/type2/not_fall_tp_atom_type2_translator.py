...
from translation.level_2.TP_atom.not_fall_TP_atom.public_class.not_fall_tp_atom_process.type2. \
    not_fall_tp_atom_type2_refiner_assembler import NotFallTPAtomType2RefinerAssembler
import copy


class NotFallTPAtomType2Translator(NotFallTPAtomType1Translator):
    """
    functions:
    ...
    def main_sentence_process(self):
        ...
        type2_refiner_assembler = NotFallTPAtomType2RefinerAssembler(new_template, predicate_cmd_dict,

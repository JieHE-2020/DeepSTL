...
from translation.level_2.TP_atom.original_TP_atom.always.simplest.SP.simplest_always_atom_template_refiner\
    import SimplestAlwaysAtomTemplateRefiner
from translation.level_2.TP_atom.original_TP_atom.always.normal.SP.always_atom_assembler import AlwaysAtomAssembler
import copy


class SimplestAlwaysAtomPreprocessor:
    """
    functions:
    ...
    def main_sentence_type1_process(self):
        ...
        main_sentence_refiner = SimplestAlwaysAtomTemplateRefiner(self.sp_info_dict, predicate_cmd_dict,

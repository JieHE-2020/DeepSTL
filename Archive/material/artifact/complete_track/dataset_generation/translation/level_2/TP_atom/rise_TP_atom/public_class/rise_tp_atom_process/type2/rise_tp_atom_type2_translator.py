from translation.level_2.TP_atom.rise_TP_atom.public_class.rise_tp_atom_process.type1. \
    rise_tp_atom_type1_translator import RiseTPAtomType1Translator
from translation.level_2.TP_atom.rise_TP_atom.public_class.rise_tp_atom_process.type2. \
    rise_tp_atom_type2_refiner_assembler import RiseTPAtomType2RefinerAssembler
import copy


class RiseTPAtomType2Translator(RiseTPAtomType1Translator):
    """
    functions:
    ...
    def main_sentence_process(self):
        ...
        type2_refiner_assembler = RiseTPAtomType2RefinerAssembler(new_template, predicate_cmd_dict,

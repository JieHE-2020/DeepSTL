...
class RiseHistoricallyAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.rise_historically_atom_translator = self.translate_process()

    @staticmethod
    def rise_tp_select():
        rise_tp_type = 'historically'
    ...
    def translate_process(self):
        ...
        rise_historically_atom_translator = RiseTPAtomTranslator(translate_guide, self.limit_num)

        return rise_historically_atom_translator
...
# }
#
# rise_historically_atom_handler = RiseHistoricallyAtomHandler(position, nest_info_dict)
# print(rise_historically_atom_handler.rise_tp_info_dict)
# print(rise_historically_atom_handler.rise_tp_info_dict['expression'])
# print(rise_historically_atom_handler.tp_info_dict['expression'])
# print('\n')
# rise_historically_atom_handler.rise_historically_atom_translator.display_random_translation()

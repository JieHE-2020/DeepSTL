...
class RiseOnceAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.rise_once_atom_translator = self.translate_process()
    ...
    def translate_process(self):
        ...
        rise_once_atom_translator = RiseTPAtomTranslator(translate_guide, self.limit_num)

        return rise_once_atom_translator
...
# }
#
# rise_once_atom_handler = RiseOnceAtomHandler(position, nest_info_dict)
# print(rise_once_atom_handler.rise_tp_info_dict)
# print(rise_once_atom_handler.rise_tp_info_dict['expression'])
# print(rise_once_atom_handler.tp_info_dict['expression'])
# print('\n')
# rise_once_atom_handler.rise_once_atom_translator.display_random_translation()

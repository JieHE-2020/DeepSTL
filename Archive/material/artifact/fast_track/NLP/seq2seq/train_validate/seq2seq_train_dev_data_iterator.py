...
class Seq2seqTrainDevDataIterator:
    def __init__(self, seed):
        ...
        self.train_data_iter = d2l.load_array(self.train_data_arrays, seq2seq_hyperparas.batch_size)
        self.dev_data_iter = d2l.load_array(self.dev_data_arrays, seq2seq_hyperparas.batch_size)
    ...
    def write_file(self, seed):
        ...
        f = open(paths.seq2seq_record_path + str(seed) + '/data_iter_dict', 'wb')
...
# seed = 100
# data = Seq2seqTrainDevDataIterator(seed)

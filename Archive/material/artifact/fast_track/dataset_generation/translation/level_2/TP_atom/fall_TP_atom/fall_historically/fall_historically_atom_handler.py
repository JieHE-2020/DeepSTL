...
class FallHistoricallyAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.fall_historically_atom_translator = self.translate_process()

    @staticmethod
    def fall_tp_select():
        fall_tp_type = 'historically'
    ...
    def translate_process(self):
        ...
        fall_historically_atom_translator = FallTPAtomTranslator(translate_guide, self.limit_num)

        return fall_historically_atom_translator
...
# }
#
# fall_historically_atom_handler = FallHistoricallyAtomHandler(position, nest_info_dict)
# print(fall_historically_atom_handler.fall_tp_info_dict)
# print(fall_historically_atom_handler.fall_tp_info_dict['expression'])
# print(fall_historically_atom_handler.tp_info_dict['expression'])
# print('\n')
# fall_historically_atom_handler.fall_historically_atom_translator.display_random_translation()

...
class DirectNegateHistoricallyAtomHandler:

    def __init__(self, translate_guide, limit_num):
        self.translate_guide = copy.deepcopy(translate_guide)
        # extract information for 'historically' operator
        self.tp_info_dict = copy.deepcopy(self.translate_guide['historically_info_dict'])

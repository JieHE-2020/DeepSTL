...
from translation.level_2.TP_atom.not_TP_atom.public_class.not_tp_atom_process.type1. \
    not_tp_atom_type1_refiner_assembler import NotTPAtomType1RefinerAssembler
import copy


class NotTPAtomType1Translator:
    """
    functions:
    ...
    def main_sentence_process(self):
        new_template = dict()
        # subject
        new_template['subject'] = copy.deepcopy(self.template['negation']['subject_with_appositive'])
        # predicate
        ...
        type1_refiner_assembler = NotTPAtomType1RefinerAssembler(new_template, predicate_cmd_dict,

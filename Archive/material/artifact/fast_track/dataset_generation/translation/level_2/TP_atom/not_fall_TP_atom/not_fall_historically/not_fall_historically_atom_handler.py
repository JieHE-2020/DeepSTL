...
class NotFallHistoricallyAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.historically_limit_num = 2000
        ...
        self.not_fall_historically_atom_translator = self.translate_process()

    @staticmethod
    def not_fall_tp_select():
        not_fall_tp_type = 'historically'
    ...
    def translate_process(self):
        ...
        not_fall_historically_atom_translator = NotFallTPAtomTranslator(translate_guide, self.limit_num)

        return not_fall_historically_atom_translator
...
# }
#
# not_fall_historically_atom_handler = NotFallHistoricallyAtomHandler(position, nest_info_dict)
# print(not_fall_historically_atom_handler.not_fall_tp_info_dict)
# print(not_fall_historically_atom_handler.not_fall_tp_info_dict['expression'])
# print(not_fall_historically_atom_handler.tp_info_dict['expression'])
# print('\n')
# not_fall_historically_atom_handler.not_fall_historically_atom_translator.display_random_translation()

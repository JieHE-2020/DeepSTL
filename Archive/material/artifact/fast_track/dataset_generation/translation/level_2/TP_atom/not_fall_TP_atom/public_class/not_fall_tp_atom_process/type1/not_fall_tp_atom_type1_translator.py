...
from translation.level_2.TP_atom.not_fall_TP_atom.public_class.not_fall_tp_atom_process.type1. \
    not_fall_tp_atom_type1_refiner_assembler import NotFallTPAtomType1RefinerAssembler
import copy


class NotFallTPAtomType1Translator:
    """
    functions:
    ...
    def main_sentence_process(self):
        ...
        type1_refiner_assembler = NotFallTPAtomType1RefinerAssembler(new_template, predicate_cmd_dict,

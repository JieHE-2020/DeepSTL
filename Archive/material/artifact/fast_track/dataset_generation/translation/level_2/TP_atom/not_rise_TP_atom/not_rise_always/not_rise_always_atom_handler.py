...
class NotRiseAlwaysAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.not_rise_always_atom_translator = self.translate_process()

    @staticmethod
    def not_rise_tp_select():
        not_rise_tp_type = 'always'
    ...
    def translate_process(self):
        ...
        not_rise_always_atom_translator = NotRiseTPAtomTranslator(translate_guide, self.limit_num)

        return not_rise_always_atom_translator
...
# }
#
# not_rise_always_atom_handler = NotRiseAlwaysAtomHandler(position, nest_info_dict)
# print(not_rise_always_atom_handler.not_rise_tp_info_dict)
# print(not_rise_always_atom_handler.not_rise_tp_info_dict['expression'])
# print(not_rise_always_atom_handler.tp_info_dict['expression'])
# print('\n')
# not_rise_always_atom_handler.not_rise_always_atom_translator.display_random_translation()

...
from translation.level_2.TP_atom.not_rise_TP_atom.public_class.not_rise_tp_atom_process.type1. \
    not_rise_tp_atom_type1_refiner_assembler import NotRiseTPAtomType1RefinerAssembler
import copy


class NotRiseTPAtomType1Translator:
    """
    functions:
    ...
    def main_sentence_process(self):
        ...
        type1_refiner_assembler = NotRiseTPAtomType1RefinerAssembler(new_template, predicate_cmd_dict,

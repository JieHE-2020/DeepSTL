from translation.level_2.TP_atom.original_TP_atom.always.simplest.simplest_always_atom_translator \
    import SimplestAlwaysAtomTranslator
import copy


class SimplestAlwaysAtomHandler:
    ...
    def __init__(self, material, limit_num):
        ...
        # get information of 'always' operator from class parameter
        self.tp_info_dict = copy.deepcopy(tp_info_dict)

        # execute translation procedure
        self.simplest_always_atom_translator = self.simplest_always_atom_translate_process()
    ...
    def simplest_always_atom_translate_process(self):
        translate_guide = [self.instruction_dict, self.tp_info_dict]
        simplest_always_atom_translator = SimplestAlwaysAtomTranslator(translate_guide, self.limit_num)

        return simplest_always_atom_translator

...
from translation.level_2.TP_atom.original_TP_atom.eventually.simplest.SP.simplest_eventually_atom_template_refiner\
    import SimplestEventuallyAtomTemplateRefiner
...
class SimplestEventuallyAtomPreprocessor:
    """
    functions:
    ...
    def main_sentence_process(self):
        main_sentence_refiner = SimplestEventuallyAtomTemplateRefiner(self.sp_info_dict, self.predicate_cmd_dict)

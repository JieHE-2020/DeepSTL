from translation.level_2.TP_atom.original_TP_atom.historically.simplest.\
    simplest_historically_atom_preprocessor import SimplestHistoricallyAtomPreprocessor


class SimplestSinceAtomHistoricallyPreprocessor(SimplestHistoricallyAtomPreprocessor):
    """
    functions:

...
class RiseUntilAtomHandler:
    ...
    def __init__(self, position, nest_info_dict, limit_num=1000):
        ...
        self.rise_until_atom_translator = self.translate_process()
    ...
    def translate_process(self):
        ...
        rise_until_atom_translator = RiseTPAtomTranslator(translate_guide, self.limit_num)

        return rise_until_atom_translator
...
# }
#
# rise_until_atom_handler = RiseUntilAtomHandler(position, nest_info_dict)
# print(rise_until_atom_handler.rise_tp_info_dict)
# print(rise_until_atom_handler.rise_tp_info_dict['expression'])
# print(rise_until_atom_handler.tp_info_dict['until']['expression'])
# print('\n')
# rise_until_atom_handler.rise_until_atom_translator.display_random_translation()
